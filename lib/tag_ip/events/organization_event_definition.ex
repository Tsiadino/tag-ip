defmodule TagIp.Events.OrganizationEventDefinition do
  use Ash.Resource,
    domain: TagIp.Domain,
  ...
  relationships do
    belongs_to :organization, TagIp.Accounts.Organization,
      source_attribute: :organization_id,
      destination_attribute: :id

    belongs_to :event_definition, TagIp.Events.EventDefinition,
