defmodule EventDefinitionWeb.HomeLive do
  ...
  defp load_event_count, do: EventDefinition.Events.EventDefinition |> Ash.count!()
  defp load_org_count, do: EventDefinition.Accounts.Organization |> Ash.count!()
end
